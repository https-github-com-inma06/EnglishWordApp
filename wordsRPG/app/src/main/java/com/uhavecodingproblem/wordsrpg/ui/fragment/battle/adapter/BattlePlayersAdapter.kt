...
import com.uhavecodingproblem.wordsrpg.ui.fragment.battle.BattleReadyActivity
...
//                Toast.makeText(itemView.context, "아이템 눌림", Toast.LENGTH_LONG).show()
//                val intent = Intent(itemView.context, BattlePlayActivity::class.java)
//
//            }
//        }
