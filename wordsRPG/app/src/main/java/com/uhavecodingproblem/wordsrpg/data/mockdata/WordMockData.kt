...
object WordMockData {
    ...
    private fun initTypeMockData(): MutableList<WordType> {
        ...
        list.add(WordType(type = "시험별", name = "토플", backgroundImage = "https://i1.daumcdn.net/thumb/C230x300/?fname=https://blog.kakaocdn.net/dn/Oo7VA/btqGG8qcrwy/p0O8FA5TfIC3BlJMIlatWk/img.jpg", words = initTestMockData()))
        return list
    }
